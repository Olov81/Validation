...
public class ValidatorBuilder<T>
{
    ...
    [SuppressMessage("Design", "CA1000:Do not declare static members on generic types", Justification = "Method does not access state")]
    ...
    {
        var propertyValidator = new PropertyValidator<T, TProperty>(propertySelector);
    ...
    {
        var validator = new NullablePropertyValidator<T, TProperty>(propertySelector, isRequired);
    ...
    {
        var validator = new ReferencePropertyValidator<T, TProperty>(propertySelector, isRequired);
        _validators.Add(validator);
        return validator.InnerValidator;
    }
}